    ...
    <Card className="h-full flex flex-col bg-amber-50">
      ...
      <CardFooter>
        <Link href={`/books/${book.id}`} className="w-full">
          <Button className="focus:outline-none text-white bg-stone-500 hover:bg-stone-600 focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" >
            View Book
          </Button>
        </Link>
      </CardFooter>
